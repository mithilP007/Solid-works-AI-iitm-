            ...
            <div className="p-6 mb-8 flex items-center justify-between">
                {!collapsed && (
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-black tracking-tighter text-white leading-none">MECHY</h1>
                            <span className="text-[10px] font-black text-primary/60 tracking-widest uppercase">DETECTIONS</span>
                        </div>
                    </div>
                )}
                <Button
